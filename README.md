...
This repo is helpful for fast coding in contests like lc,cc,cf.... This contains most used DSA.In future I keep on updating if learn any new thing or if it neccessary to add new things 
